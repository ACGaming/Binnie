...
public class PageSpeciesTreeGenome extends PageSpecies {
	...
	public void onValueChanged(final IAlleleSpecies species) {
		...
		new ControlText(contents, new Area(0, y, w2, th), I18N.localise("extratrees.gui.database.plantType") + " : ", TextJustification.MIDDLE_RIGHT);
		new ControlText(contents, new Area(w2, y, w3, th), I18N.localise("extratrees.gui.database.plantType." + treeSpecies.getPlantType().name().toLowerCase()), TextJustification.MIDDLE_LEFT);
		y += th;
		...
		new ControlText(contents, new Area(w2, y, w3, th), AlleleHelper.toDisplay(treeSpecies.getTemperature()), TextJustification.MIDDLE_LEFT);
		y += th;
